   ...
   <main>
            ...
            <div class="row justify-content-center">
               <div class="col-xl-10">
                  <div class="breadcrumb__content text-center">
                     <h3 class="breadcrumb__title">Contactez-nous
            ...
            <div class="row">
               <div class="col-lg-6">
                  <div class="tp-contact-wrapper">
                     <div class="tp-contact-title-wrapper">
                        <h3 class="tp-contact-title">Laissez-nous <span class="title-color">un message</span></h3> 
                        <p>Nous sommes joignables sur email, appel et autres pour répondre à vos préoccupations.</p>
                     </div>
                     <div class="tp-contact-content">
                        <div class="tp-contact-content-mail d-flex align-items-center">
                           ...
                           <h3 class="tp-contact-item-title"><a href="mailto:contact@ahtsgroup.com">contact@ahtsgroup.com</a></h3>
                        </div>
                        <div class="tp-contact-content-phone d-flex align-items-center">
                           ...
                           <h3 class="tp-contact-item-title"><a href="tel:+17208389047">+1 720 838 9047</a></h3>
                        </div>
                        <div class="tp-contact-location-wrapper d-flex">
                           <div class="tp-contact-location">
                              <h3 class="tp-contact-location-title">Localisation géographique <i class="fa-regular fa-arrow-down"></i></h3>
                              <p>3061 W 92nd Ave Westminster CO 80031</p>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="col-lg-6">
                  <div class="tp-contact-form">
                     <h3 class="tp-contact-form-title">Contactez-nous</h3>
                     <p>Votre email ne sera pas publié. Les champs obligatoires sont marqués par un *</p>
                     <form id="contact-form" action="" method="POST">
                        <div class="row tp-gx-10">
                           ...
                           <div class="col-md-6">
                              <div class="tp-contact-input">
                                 <input name="text" type="text" placeholder="Objet du message*" required>
                              </div>
                           </div>
                           <div class="col-md-6">
                              <div class="tp-contact-input">
                                 <input name="text" type="text" placeholder="Téléphone*" required>
                              </div>
                           </div>
                           <div class="col-md-12">
                              <div class="tp-contact-input">
                           ...
                           <div class="tp-contact-btn mt-10">
                              <button type="submit" class="tp-btn">Envoyez votre message</button>
                           </div>
                        </div>
                     </form>
                  </div>
      ...
      <div class="tp-contact-map-area">
         <div class="tp-contact-map">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3062.4303271955064!2d-105.02879762616672!3d39.86459777153363!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x876c7625e348bf0d%3A0x4aa6c59e6a65efb!2s3061%20W%2092nd%20Ave%2C%20Westminster%2C%20CO%2080031%2C%20%C3%89tats-Unis!5e0!3m2!1sfr!2sbj!4v1707217903169!5m2!1sfr!2sbj" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
         </div>
      </div>
